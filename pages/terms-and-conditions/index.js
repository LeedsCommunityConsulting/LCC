  ...
  return (
    <Container>
      <Row className="pb-5">
        <Col lg={2} xs={1} />
        <Col lg={8} xs={10}>
          <h1 className="title py-3">Terms & Conditions</h1>
          <p>Welcome to Leeds Community Consulting!</p>
          <p>
            These terms and conditions outline the rules and regulations for the use of Leeds Community
            Consulting&apos;s Website, located at{' '}
            <a className="lcc-link" href="https://leedscomunityconsulting.com">
              https://leedscomunityconsulting.com.
            </a>
          </p>
          <p>
            By accessing this website, we assume you accept these terms and conditions. Do not continue to use
            Leeds Community Consulting if you do not agree to take all of the terms and conditions stated on
            this page.
          </p>
          <string className="subtitle">Cookies:</string>
          <p>
            The website uses cookies to help personalize your online experience. By accessing Leeds Community
            Consulting, you agreed to use the required cookies.
          </p>
          <p>
          ...
          <p>
            We may use cookies to collect, store, and track information for statistical or marketing purposes
            to operate our website. You have the ability to accept or decline optional Cookies. There are some
          ...
          <string className="subtitle">License:</string>
          <p>
            Unless otherwise stated, Leeds Community Consulting and/or its licensors own the intellectual
            property rights for all material on Leeds Community Consulting. All intellectual property rights
            are reserved. You may access this from Leeds Community Consulting for your own personal use
            subjected to restrictions set in these terms and conditions.
          </p>
          <p>You must not:</p>
          <ul>
            <li>Copy or republish material from Leeds Community Consulting</li>
            <li>Sell, rent, or sub-license material from Leeds Community Consulting</li>
            <li>Reproduce, duplicate or copy material from Leeds Community Consulting</li>
            <li>Redistribute content from Leeds Community Consulting</li>
          </ul>
          <p>This Agreement shall begin on the date hereof.</p>
          <p>
            Parts of this website offer users an opportunity to post and exchange opinions and information in
            certain areas of the website. Leeds Community Consulting does not filter, edit, publish or review
            Comments before their presence on the website. Comments do not reflect the views and opinions of
            Leeds Community Consulting, its agents, and/or affiliates. Comments reflect the views and opinions
            of the person who posts their views and opinions. To the extent permitted by applicable laws, Leeds
            Community Consulting shall not be liable for the Comments or any liability, damages, or expenses
            caused and/or suffered as a result of any use of and/or posting of and/or appearance of the
            Comments on this website.
          </p>
          <p>
            Leeds Community Consulting reserves the right to monitor all Comments and remove any Comments that
          ...
          <p>
            You hereby grant Leeds Community Consulting a non-exclusive license to use, reproduce, edit and
            authorize others to use, reproduce and edit any of your Comments in any and all forms, formats, or
            media.
          </p>
          <string className="subtitle">Hyperlinking to our Content:</string>
          ...
          <p>
            ...
            compensates the absence of Leeds Community Consulting; and (d) the link is in the context of
          ...
          <p>
            ...
            our website, you must inform us by sending an e-mail to Leeds Community Consulting. Please include
          ...
          <ul>
            ...
            <li>
              Using any other description of our Website being linked to that makes sense within the context
              and format of content on the linking party&apos;s site.
            </li>
          </ul>
          <p>
            No use of Leeds Community Consulting&apos;s logo or other artwork will be allowed for linking
            absent a trademark license agreement.
          </p>
          <string className="subtitle">Content Liability:</string>
          <p>
            We shall not be held responsible for any content that appears on your Website. You agree to
            protect and defend us against all claims that are raised on your Website. No link(s) should appear
          ...
          <string className="subtitle">Reservation of Rights:</string>
          <p>
          ...
          <string className="subtitle">Removal of links from our website:</string>
          <p>
          ...
          <string className="subtitle">Disclaimer:</string>
          <p>
